...
//   hash:
// }
var appwriteFunc = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var client, account, avatars, database, functions, health, locale, storage, teams, users, eventData, databaseId, userSessionCollectionId, createUserSessionDoc, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!eventData.$id) return [3 /*break*/, 3];
                    databaseId = '6479a05b96a60acff24e';
                    userSessionCollectionId = '6479a070bbdfdddab0fd';
                    return [4 /*yield*/, database.createDocument(databaseId, userSessionCollectionId, eventData.$id, {
                            sessionIds: [],
                        })];
                case 2:
                    createUserSessionDoc = _a.sent();
